 ...
 * @author wupanjie
 */
public abstract class StickerNew {
  ...
  @NonNull
  public StickerNew setFlippedHorizontally(boolean flippedHorizontally) {
  ...
  @NonNull public StickerNew setFlippedVertically(boolean flippedVertically) {
  ...
  public StickerNew setMatrix(@Nullable Matrix matrix) {
    this.matrix.set(matrix);
    return this;
  }

  public abstract DrawableStickerNew setDrawable(@NonNull GifDrawable drawable);
  ...
  public abstract StickerNew setDrawable(@NonNull Drawable drawable);

  @NonNull public abstract Drawable getDrawable();

  @NonNull public abstract StickerNew setAlpha(@IntRange(from = 0, to = 255) int alpha);
