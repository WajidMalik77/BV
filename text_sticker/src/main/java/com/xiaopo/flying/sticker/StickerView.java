...
public class StickerView extends FrameLayout {
    ...
    public boolean isStickerFocus = false;
    ...
    protected void dispatchDraw(Canvas canvas) {
        try {
            ...
            Log.e("StickerView","dispatchDraw: Ignore this Exception for now: "+e.getMessage());
        }
    }

    public boolean isStickerFocus() {
        return isStickerFocus;
    }

    public void clearBorders() {
        showIcons = false;
        showBorder = false;
        isStickerFocus = false;
        invalidate();
    }
...
//        transformSticker(sticker);
    ...
    public void save(@NonNull File file) {
        try {
            StickerUtils.saveImageToGallery(getContext(), file, createBitmap());
