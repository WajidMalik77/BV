...
public class TextSticker extends Sticker {
    ...
    @NonNull
    public TextSticker setGradientTextColor(String color1, String color2) {
        int starColor = Color.parseColor(color1);
        int endColor = Color.parseColor(color2);
        ///
//        float width = textPaint.measureText("Tianjin, China");
        float width = textPaint.measureText(getText());
        Shader textShader = new LinearGradient(0, 0, width, 30,
                new int[]{
                        starColor,
...
//    textPaint.setTextSize();
    ...
    public void setBorderTextColor(String color,float borderRadius){
        int solidColor = textPaint.getColor();

        int shadowColor=Color.parseColor(color);
        float width = textPaint.measureText(getText());
//        Shader textShader = new LinearGradient(0, 0, width, 30,
//                new int[]{
//                        shadowColor,
...
//                }, null, Shader.TileMode.CLAMP);
//        textPaint.setShader(textShader);
        //textPaint.setColor(solidColor);
        textPaint.setStyle(Paint.Style.FILL);
        textPaint.clearShadowLayer();

        textPaint.setShadowLayer(2f,3.0f, 3.0f, Color.parseColor(color));
    }

    public void setTextColorAndremoveTextGradientIfexist(String color){
        int solidColor = Color.parseColor(color);
//        float width = textPaint.measureText(getText());
//        Shader textShader = new LinearGradient(0, 0, width, 30,
//                new int[]{
//                        solidColor,
...
//        textPaint.setShader(textShader);
    ...
    public GradientDrawable setBackgroundColorOpacity(int[] bgGradientColors, String bgColor, int bgOpacity, int stickerWidth, int stickerHeight) {
...
//    gradientDrawable.setColors(bgGradientColors);
    ...
    //////////////// new functions created for true love 2
