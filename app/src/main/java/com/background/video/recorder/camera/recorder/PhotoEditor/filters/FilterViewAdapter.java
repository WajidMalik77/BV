package com.background.video.recorder.camera.recorder.PhotoEditor.filters;
...
public class FilterViewAdapter extends RecyclerView.Adapter<FilterViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_filter_view_apptronix, parent, false);
    ...
    private void setupFilters() {
        mPairList.add(new Pair<>("filters/orignal.png", PhotoFilter.ORIGNAL));
        ...
        mPairList.add(new Pair<>("filters/due_tone.png", PhotoFilter.DUE_TONE));
