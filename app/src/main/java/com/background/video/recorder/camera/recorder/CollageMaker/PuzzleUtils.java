...
import com.background.video.recorder.camera.recorder.CollageMaker.layout.slant.OneSlantLayout;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.slant.SlantLayoutHelper;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.slant.ThreeSlantLayout;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.slant.TwoSlantLayout;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.straight.EightStraightLayout;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.straight.FiveStraightLayout;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.straight.FourStraightLayout;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.straight.NineStraightLayout;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.straight.OneStraightLayout;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.straight.SevenStraightLayout;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.straight.SixStraightLayout;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.straight.StraightLayoutHelper;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.straight.ThreeStraightLayout;
import com.background.video.recorder.camera.recorder.CollageMaker.layout.straight.TwoStraightLayout;
